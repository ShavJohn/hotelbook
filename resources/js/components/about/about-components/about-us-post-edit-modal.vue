<template>
    <modals modal-id="about-us-modal">
        ...
        <template #modal-footer>
            ...
            <button type="button" class="modal-btn btn-action" @click="updateAboutUsPage(aboutUsContent)">Update</button>
        </template>
    </modals>
</template>
